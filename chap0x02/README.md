...
```
- 输入`127.0.0.1:8080/teacher`

### 攻击  

- teacher表

<img src="./简易教务系统的漏洞web开发/1.png" height=50>

- `url/grade`

<img src="./简易教务系统的漏洞web开发/2.png" height=150>

- 结果

<img src="./简易教务系统的漏洞web开发/3.png" height=40>

## 参考

- [hw-0x02-Web Application - purplezi ](https://github.com/purplezi/Software-and-System-Security/tree/master/hw-0x02-Web%20Application%20(%20Easy%20Educational%20Administration%20System))